      ...
      @include('frontend.includes.navbar')
       <section id="blog-header" style="background-image: url('images/blog/entry-placeholder-1920x400.png');">
        <div class="blog-title">
            <h1>{{ $entry->title }}</h1>
        </div>
    </section>
    <section id="blog-content">
        <div class="container bg-grain">
            <div class="row">
                <div class="col-md-12 blog-post-bg">
            
                    <p>{{ $entry->content }}</p>

                    {{ HTML::image(URL::to('/') . '/uploads/frontend/blog/' . $entry->image, $entry->title) }}
    ...
    <section id="fb-social-comments">
        <div class="row">
            <div class="container">
                <div class="fb-comments" data-href="http://www.stipino.com" data-width="100%" data-numposts="5"></div>
            </div>
        </div>
        </div>
    </section>
