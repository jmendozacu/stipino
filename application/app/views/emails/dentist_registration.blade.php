			...
			<tbody>
				<tr>
					<td style="border-left: 1px solid #d0d0d0; border-right: 1px solid #d0d0d0; border-bottom: 1px solid #d0d0d0; padding: 20px 10px; text-align: center;">
						<h1>Poštovani, hvala vam na registraciji!</h1>
					</td>
				</tr>
				...
				<tr>
					<td style="border-left: 1px solid #d0d0d0; border-right: 1px solid #d0d0d0; border-bottom: 1px solid #d0d0d0; padding: 20px 10px; text-align: center;">
						Dentist finder je aplikacija koja pomaže u povezivanju pacijenata i zubara <br />

						Kako bi popunili svoj profil,  <a href="http://localhost:8000/zubari/registracija"> slijedite ovu poveznicu</a>
					</td>
				</tr>

				<tr>
					<td style="border-left: 1px solid #d0d0d0; border-right: 1px solid #d0d0d0; border-bottom: 1px solid #d0d0d0; padding: 20px 10px; text-align: center;">
						Hvala na registraciji, Dentist finder
					</td>
				</tr>
				<tr>
					<td>
