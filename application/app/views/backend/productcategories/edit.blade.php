...
<ul class="breadcrumb">
    ...
    <li><a href="{{ URL::route('ProductCategoryIndex') }}">Pregled svih kategorija proizvoda</a></li>
    <li class="active">Uredi kategoriju proizvoda</li>
</ul>
<div class="panel-heading">
	<div class="row">
	    <div class="col-md-10">
    		<h4>Uredi kategoriju proizvoda</h4>
    	</div>
    	<div class="col-md-2">
      		<a href="{{ URL::route('ProductCategoryIndex') }}">
...
<div class="panel-body">
	<div class="row">
		...
		{{ Form::hidden('product_category', 'product', array('product_category' => 'product_category')) }}
	    <div class="col-md-4">
