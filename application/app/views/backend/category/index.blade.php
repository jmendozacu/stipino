 ...
 <ul class="breadcrumb">
    ...
    <li class="active"><a href="{{ URL::route('CategoryIndex') }}">Pregled svih kategorija</a></li>
    
    <a href="{{ URL::route('CategoryCreate') }}" class="pull-right" style="margin-top: -5px;">
...
<div class="panel-heading">
    <h4>Pregled svih kategorija ({{$blogcategorycount}})</h4>
</div>
             ...
             @if (count($entries['entries']) > 0) 
                ...
                <tr>
                    ...
                    <td class="col-md-1">
                        ...
                        <a href="{{ URL::route('CategoryEdit', array('id' => $entry->id)) }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ URL::route('CategoryDestroy', array('id' => $entry->id)) }}">
