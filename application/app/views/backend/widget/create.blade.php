...
<ul class="breadcrumb">
    ...
    <li class="active">Dodaj widget</li>
</ul>
<div class="panel-heading">
	<div class="row">
	    <div class="col-md-10">
    		<h4>Unos novog widgeta</h4>
    	</div>
    	<div class="col-md-2">
	...
	<div class="row">
	    ...
	    <div class="col-md-8">
	            <div class="form-group">  
					...
					{{ Form::text('title', isset($entry->title) ? $entry->title : null, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Naslov widgeta']) }}
					<small class="text-danger">{{ $errors->first('title') }}</small>
	            </div>
	         	<div class="form-group">  
	                <label for="title">Poveznica:</label>  
					{{ Form::text('permalink', isset($entry->permalink) ? $entry->permalink : null, ['class' => 'form-control', 'id' => 'permalink', 'placeholder' => 'Poveznica widgeta']) }}
	    ...
	    <div class="col-md-4"> 
	       <div class="form-group m0 mb15">
	            ...
	            {{ Form::select('published', array('draft' => 'Skica', '1' => 'Objavljeno'), 'draft', array('class'=>'form-control','style'=>'' )) }}
	        </div>
